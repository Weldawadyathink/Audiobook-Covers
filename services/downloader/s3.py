...
def upload_single_image(s3, image, key, content_type):
...
def upload_image_variations(image: Image, image_id, file_extension, file_path):
    s3 = boto3.client('s3',
    ...
    for img_format, size, bytes, content_type in get_all_image_versions(image):
        ...
        upload_single_image(s3, bytes, key, content_type)
